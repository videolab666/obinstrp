...
if(PLUGIN_EMAIL)
  ...
  # CPack requires a non-empty maintainer even when a project intentionally
  # does not publish a contact email in buildspec.json.
  set(CPACK_DEBIAN_PACKAGE_MAINTAINER "${PLUGIN_AUTHOR}")
endif()
